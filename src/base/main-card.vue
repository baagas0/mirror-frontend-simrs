<template>
  <div class="card-wrapper">
    <div class="card card-custom mb-5">
      ...
      <div class="card-header border-0 py-0" v-if="false">
        <div class="card-title flex-fill mr-0">
      ...
      <div class="card-body pt-3 d-none" v-if="$slots['inline-filter']">
    ...
    <masonry v-if="mainData.length>0" :cols="{default: 1, 1024: 1, 768: 1, 425: 1}" :gutter="{default: '.75rem', 700: '15px'}">
      <div v-for="(b,i) in mainData" :key="i+'-item-card'">
    ...
    <div v-if="mainData.length>0" class="d-flex justify-content-center align-items-center flex-wrap">
      <div class="pagination d-flex flex-wrap py-2 mr-3">
        <button type="button" @click="goPage('first')" :disabled="paramAPI.page == 1" class="btn btn-text btn-icon btn-sm btn-primary mr-1 my-1" style="height: 32.9px;width: 32.9px;">
        ...
        <button type="button" @click="goPage('last')" :disabled="paramAPI.page == maxPage" class="btn btn-text btn-icon btn-sm btn-primary mr-1 my-1" style="height: 32.9px;width: 32.9px;">
...
export default {
  ...
  watch: {
    urlProperties: {
      ...
      immediate: false,
      handler (to, from) {
        console.log('watcher urlProperties', to.page, from.page)
        this.getData(to, true)
    ...
    goPage (e, event = null) {
      ...
      switch (e) {
        ...
        case 'last':
          ...
          break
        case 'next':
          console.log('next', this.paramAPI.page, this.maxPage)
