  ...
  <div>
    <div class="d-flex align-items-center mt-5">
      ...
      <div class="d-flex flex-column">
        <span class="font-weight-bold font-size-h5 text-dark" style="word-break: break-word;">{{ profile.fullname }}</span>
        <div class="text-muted mt-1">{{ profile.role_name }}</div>
        <div class="navi mt-4">
    ...
    <table class="table no-border mb-0">
      <tr>
        ...
        <th class="pr-0">{{ profile.telephone }}</th>
      </tr>
      <tr>
        <td class="nowrap-table pl-0">Email</td>
        <th style="word-break: break-all;">{{ profile.email }}</th>
      </tr>
    </table>
    ...
    <template>
      <div class="separator separator-dashed mt-8 mb-5"></div>
      <span class="d-block font-weight-bolder text-dark-75 text-sm mb-3">Konfigurasi Sistem</span>
      <div class="form-group row mb-1">
        <label class="col col-form-label">Pembaruan Modul</label>
        <div class="col-auto text-right">
          <button @click="reloadModule()" class="btn btn-sm btn-light-info">
            <i class="ri-refresh-line"></i> Update
          </button>
        </div>
      </div>
      <!-- <div class="form-group row mb-1">
        <label class="col col-form-label">Gunakan Tema Gelap</label>
