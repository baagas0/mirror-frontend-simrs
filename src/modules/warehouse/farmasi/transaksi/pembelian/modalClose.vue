  ...
  export default {
    ...
    methods: {
      ...
      closed(){
        ...
        axios
          // .post(ipBackend + "pembelian/closed", {id: vm.data.pembelian_id, tgl_masuk: moment(vm.is_data.tgl_masuk).format('YYYY-MM-DD'), ubah_harga_pokok: vm.is_data.ubah_harga_pokok})
          .post(ipBackend + "/pembelian/closed", {id: vm.data.pembelian_id, ...vm.is_data})
          .then((res) => {
