      ...
      methods: {
        openModal(){
          ...
          if(vm.data){
            ...
            // ===== jika punya po =====
            if(vm.data.tgl_po){
              vm.is_data.nama_tgl_po = new Date(vm.data.tgl_po)
              // console.log('ini po ke pembelian')
              axios
              .post(ipBackend + "/subPo/getByIdPembelian", vm.data)
              .then((res)=>{
                ...
                vm.table_po = res.data.data
                // vm.busy = false
                
                // ===== get data sub pembelian =====
                axios
                .post(ipBackend + "/subPembelian/getByIdPembelian", {ms_pembelian_id: vm.data.pembelian_id})
                .then((res)=>{
            ...
            // ===== data default =====
            vm.is_data.tgl_faktur = vm.data.tgl_faktur ? new Date(vm.data.tgl_faktur) : new Date()
            vm.is_data.nama_total_pembelian = vm.toNumeric(vm.data.total_pembelian, 'idr')
            //gudang
