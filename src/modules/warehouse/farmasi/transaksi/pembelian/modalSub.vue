  ...
  export default {
    ...
    methods: {
      bukaModal(){
        ...
        axios
        .post(ipBackend + "/subPembelian/getByIdPembelian", {ms_pembelian_id: vm.data_sub.pembelian_id})
        .then((res)=>{
      ...
      update() {
        ...
        axios
          .post(ipBackend + "/subPembelian/update", vm.is_data)
          .then((res) => {
      ...
      simpan() {
        ...
        vm.is_data.satuan_beli = null
        axios
          .post(ipBackend + "/subPembelian/register", vm.is_data)
          .then((res) => {
      ...
      deleteSub(){
        ...
        axios
          .post(ipBackend + "/subPembelian/delete", x)
          .then((res) => {
            if (res.data.message == "sukses") {
              vm.button = "Simpan";
              vm.busy = false;
