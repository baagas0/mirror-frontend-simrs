  ...
  export default {
    ...
    watch: {
      data_edit(newVal, oldVal) {
        if(newVal != oldVal && newVal){
          this.is_data = newVal;
          console.log(newVal)
          this.is_data.tgl_faktur = new Date(newVal.tgl_faktur)
          //gudang
    ...
    methods: {
      ...
      simpan() {
        ...
        vm.is_data.tgl_faktur = moment(vm.is_data.tgl_faktur).format('YYYY-MM-DD')
        axios
          .post(ipBackend + "/pembelian/update", vm.is_data)
          .then((res) => {
