                ...
                <div>
                  <b-row style="row-gap: 15px; margin-bottom: 2rem">
                    ...
                    <b-col cols="3">
                      <s-input
                        groupClass="mb-0"
                        v-model="fields.jadwal_dokter_id"
                        :item="{
                          label: 'Jadwal Dokter',
                          id: 'jadwal_dokter_id',
                        ...
                        :valuee="fields.jadwal_dokter_id"
                  ...
                  <b-row style="row-gap: 15px">
                    ...
                    <b-col cols="3" v-if="conditionalFields.no_rujukan.value" class="d-flex flex-column">
                      ...
                      <b-button class="w-100 mb-2" variant="info" @click="getRujukanBerdasarkanNomorKartuMulti">Cari Daftar No Rujukuan (No Kartu)</b-button>
                    ...
                    <b-col cols="3" v-if="conditionalFields.no_kontrol.value" class="d-flex flex-column">
                      ...
                      <b-input-group>
                        <b-form-input v-model="optionalFields.no_kontrol.text" type="text" :placeholder="'Isikan No Kontrol'" :value="optionalFields.no_kontrol.text"></b-form-input>
                        <b-input-group-append>
                  ...
                  <b-row class="mt-2">
                    <b-col cols="6" v-if="modeSubmit === modes.edit && conditionalFields.no_sep.value">
                      <div>
                        ...
                        <b-input-group>
                          <b-form-input v-model="fields.no_sep" type="text" :placeholder="'Isikan No SEP'" :disabled="!isBpjsValid || !fields.no_asuransi_registrasi"></b-form-input>
                          <b-input-group-append>
                            <b-button sizes="lg" variant="info" @click="openModalSEP" class="px-8" :disabled="!isBpjsValid || !fields.no_asuransi_registrasi">SEP</b-button>
                          </b-input-group-append>
                        </b-input-group>
                      </div>
                    </b-col>
      ...
      <b-modal id="modal-tutup-kunjungan" title="Tutup Kunjungan" hide-footer>
        ...
        <b-col cols="12">
          <div class="d-flex align-items-center mt-6">
            <b-button block sizes="lg" variant="primary" @click="tutupKunjungan" class="mt-0 text-nowrap"> Submit tutup kunjungan </b-button>
          </div>
        </b-col>
        <!-- </form> -->
      </b-modal>

      <ModalSEP :no_asuransi_registrasi="fields.no_asuransi_registrasi" :modalSEP1="modalSEP1" :modalSEP2="modalSEP2" :pesertaProps="fields" :jenisKunjungan="'Rajal'" @createdSEP="handleCreatedSEP" :noSEP="fields.no_sep" @deletedSEP="handleDeletedSEP" @closeModalSEP="handleCloseModalSEP" @openModalSEP="handleOpenModalSEP" />
    </div>
        ...
        <b-col cols="12">
          <b-card class="" hide-header>
            <div>
              <b-row style="row-gap: 15px; margin-bottom: 2rem">
                <b-col cols="12">
                  <DaftarKunjunganRegistrasi ref="table-daftar-kunjungan" :jenisKunjungan="'Rajal'" @selectKunjungan="handleSelectKunjungan" :isCreatedOrUpdated="isCreatedOrUpdated" @isCreatedOrUpdated="handleIsCreatedOrUpdated" />
                </b-col>
              </b-row>
            </div>
          </b-card>
        ...
        .then((res) => {
          if (res.isConfirmed) {
            ...
            if (res.value && this.modeSubmit === this.modes.add) {
              ...
              paramSocket.status_isolasi = this.normalizeBooleanValue(paramSocket.status_isolasi);
