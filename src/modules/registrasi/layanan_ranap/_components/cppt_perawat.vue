...
<script>
import Subjective from './cppt_perawat/subjective.vue'
import Objective from './cppt_perawat/objective.vue'
import Assesment from './cppt_perawat/assesment.vue'
import Planning from './cppt_perawat/planning.vue'
...
export default {
  ...
  methods: {
    updateAssesmen(data = {}) {
      console.log('updateAssesmen cppt_perawat')
