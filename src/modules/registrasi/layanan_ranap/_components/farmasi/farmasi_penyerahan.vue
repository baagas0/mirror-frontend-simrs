    ...
    <template v-if="state === 'list'">
                      ...
                      <div class="row align-items-center">
                        ...
                        <div class="col-2 align-items-start">
                          <label class="checkbox checkbox-outline checkbox-danger">
                            <input type="checkbox" :name="'status_resep_detail_rnap'+item.id" v-model="item.status_resep_detail_rnap" :disabled="oResep.tahap_resep > 4" :checked="item.status_resep_detail_rnap"  @change="updateResepDetail(item)" />
                            <span></span>
                          </label>
                        </div>
                      </div>
      ...
      <div class="row px-3">
        <div class="col-3">
          <div class="checkbox-list mt-3">
            <label class="checkbox">
              <input type="checkbox" name="tepat_obat" :disabled="oResep.tahap_resep > 4" v-model="oResep.tepat_obat" :checked="oResep.tepat_obat" @change="$emit('updateResepData', { ...oResep })" />
              <span></span>
              Tepat Obat
            </label>
          </div>
          <div class="checkbox-list mt-3">
            <label class="checkbox">
              <input type="checkbox" name="resep_lengkap" :disabled="oResep.tahap_resep > 4" v-model="oResep.resep_lengkap" :checked="oResep.resep_lengkap"  @change="$emit('updateResepData', { ...oResep })" />
              <span></span>
              Resep Lengkap
            </label>
          </div>
          <div class="checkbox-list mt-3">
            <label class="checkbox">
              <input type="checkbox" name="pasien_sesuai" :disabled="oResep.tahap_resep > 4" v-model="oResep.pasien_sesuai" :checked="oResep.pasien_sesuai"  @change="$emit('updateResepData', { ...oResep })" />
              <span></span>
              Pasien Sesuai
            </label>
          </div>
          <div class="checkbox-list mt-3">
            <label class="checkbox">
              <input type="checkbox" name="tidak_duplikasi" :disabled="oResep.tahap_resep > 4" v-model="oResep.tidak_duplikasi" :checked="oResep.tidak_duplikasi"  @change="$emit('updateResepData', { ...oResep })" />
              <span></span>
              Tidak Duplikasi
            </label>
          </div>
        ...
        <div class="col-3">
          <div class="checkbox-list mt-3">
            <label class="checkbox">
              <input type="checkbox" name="tepat_dosis" :disabled="oResep.tahap_resep > 4" v-model="oResep.tepat_dosis" :checked="oResep.tepat_dosis"  @change="$emit('updateResepData', { ...oResep })" />
              <span></span>
              Tepat Dosis
            </label>
          </div>
          <div class="checkbox-list mt-3">
            <label class="checkbox">
              <input type="checkbox" name="campuran_obat_stabil" :disabled="oResep.tahap_resep > 4" v-model="oResep.campuran_obat_stabil" :checked="oResep.campuran_obat_stabil"  @change="$emit('updateResepData', { ...oResep })" />
              <span></span>
          ...
          <div class="checkbox-list mt-3">
            <label class="checkbox">
              <input type="checkbox" name="tidak_alergi" :disabled="oResep.tahap_resep > 4" v-model="oResep.tidak_alergi" :checked="oResep.tidak_alergi"  @change="$emit('updateResepData', { ...oResep })" />
              <span></span>
              Tidak Alergi
            </label>
          </div>
        ...
        <div class="col-4">
          ...
          <div class="checkbox-list mt-3">
            <label class="checkbox">
              <input type="checkbox" name="rute_pemberian" :disabled="oResep.tahap_resep > 4" v-model="oResep.rute_pemberian" :checked="oResep.rute_pemberian"  @change="$emit('updateResepData', { ...oResep })" />
              <span></span>
              Rute Pemberian
            </label>
          </div>
          <div class="checkbox-list mt-3">
            <label class="checkbox">
              <input type="checkbox" name="tidak_interaksi" :disabled="oResep.tahap_resep > 4" v-model="oResep.tidak_interaksi" :checked="oResep.tidak_interaksi"  @change="$emit('updateResepData', { ...oResep })" />
              <span></span>
              Tidak Interaksi
            </label>
          </div>
