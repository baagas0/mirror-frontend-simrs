  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-xl-3 col-md-3 col-sm-12">
        <card-registrasi-rnap @selected="selectRegistrasi"/>
      </div>
      <div class="col-xl-9 col-md-9 col-sm-12">
        ...
        <template v-else-if="dataRegistrasi && registrasi_id">
          <!-- HERE -->
          <rad :registrasi_id="registrasi_id"></rad>
        </template>
        <template v-else>
...
<script>
  import CardRegistrasiRnap from './_components/card_registrasi_ranap.vue'
  import Rad from '../radiologi/rad_regis.vue'
  ...
  export default {
    ...
    components: { CardRegistrasiRnap, Rad },
    data () {
      return {
        info_alert: '',
