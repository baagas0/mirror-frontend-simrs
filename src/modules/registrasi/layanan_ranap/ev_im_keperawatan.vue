      ...
      <div class="xl-9 col-md-9 col-sm-12">
        <div class="card card-custom mb-5 card-sticky" v-if="dataRegistrasi && registrasi_id">
          <div class="card-body ribbon ribbon-right">
            <div v-if="tab === 'assesmen_tambahan'" class="ribbon-target" :class="{ 'bg-warning': !is_validasi_assesmen_tambahan, 'bg-success': is_validasi_assesmen_tambahan }" style="top: 10px; right: 0px">{{ is_validasi_assesmen_tambahan ? "Sudah" : "Belum" }} Validasi</div>
                ...
                <div class="card mb-5">
                  ...
                  <div class="card-body p-3">
                    ...
                    <template v-else-if="listImplementasiKeperawatanV2.length > 0">
                      <div v-for="(item, i) in listImplementasiKeperawatanV2" :key="'implementasi-v2-' + i" class="card p-3 mb-3 bg-light-warning card-list-hover" :class="{ 'card-active': selectedImplementasiId === item.id }">
                        <div class="d-flex flex-row justify-content-between align-items-start">
                          <div class="w-100 pointer" @click="selectImplementasi(item)">
                            <p class="mb-2">
                              <strong>{{ item.waktu_implementasi | parse("longDateTime") }}</strong>
                            </p>
                      ...
                      <ValidationObserver v-slot="{ handleSubmit }">
                        <form @submit.prevent="handleSubmit(onSubmitImplementasi)" autocomplete="off">
                          <div class="row">
                            <div class="col-12">
                              <s-input
                                v-model="vImplementasi.waktu_implementasi"
                                :item="{
                            ...
                            <div class="col-12">
                              <s-input
                                v-model="vImplementasi.diagnosa"
                                :item="{
                                  label: 'Diagnosa',
                                  id: 'diagnosa',
                                  data: 'diagnosa',
                            ...
                            <div class="col-12">
                              <s-input
                                v-model="vImplementasi.implementasi"
                                :item="{
                                  label: 'Implementasi',
                                  id: 'implementasi',
                                  data: 'implementasi',
                            ...
                            <div class="col-12">
                              <s-input
                                v-model="vImplementasi.respon_pasien"
                                :item="{
                                  label: 'Respon Pasien',
                                  id: 'respon_pasien',
                                  data: 'respon_pasien',
                      ...
                      <div class="card card-custom bg-light-success mb-5">
                        <div class="card-body p-4">
                          <div class="d-flex flex-row justify-content-between align-items-start" style="gap: 16px">
                            <div class="w-100">
                              <p class="mb-2">
                                <strong>{{ selectedImplementasiData.waktu_implementasi | parse("longDateTime") }}</strong>
                              </p>
                ...
                <div class="card">
                  ...
                  <div class="card-body p-3">
                    ...
                    <template v-else-if="listLegacyEvaluasiKeperawatan.length > 0">
                      <div v-for="(item, i) in listLegacyEvaluasiKeperawatan" :key="'legacy-evaluasi-' + i" class="card p-3 mb-3" :class="{ 'implementasi-keperawatan-active': item.status_evaluasi_keperawatan, 'bg-gray-500': !item.status_evaluasi_keperawatan }">
                        ...
                        <div class="legacy-wrapper">
                          ...
                          <template v-if="item.implementasi && item.implementasi.length > 0">
                            <div v-for="(legacyImplementasi, j) in item.implementasi" :key="'legacy-implementasi-' + i + '-' + j" class="bg-white rounded p-4 mb-3">
                              <p class="mb-2">
                                <strong>{{ legacyImplementasi.waktu_implementasi | parse("longDateTime") }}</strong>
                              </p>
        ...
        <template v-else-if="tab === 'assesmen_tambahan'">
          <div class="card">
            ...
            <div class="card-body p-0">
              <KesehatanIbuAnak v-if="dataAssesmenTambahan && dataAssesmenTambahan.kesehatan_ibu_anak" :dataRegistrasi="dataRegistrasi" :assesmen="dataAssesmenTambahan.kesehatan_ibu_anak" :activeTab="activeTabKIA" :dataAssesmenTambahan="dataAssesmenTambahan" :is_validasi_assesmen_tambahan="is_validasi_assesmen_tambahan" />
            </div>
          </div>
        </template>
      </div>
...
const normalizeLegacyEvaluasiItem = (item = {}) => ({
  ...
  status_evaluasi_keperawatan: toBoolean(item.status_evaluasi_keperawatan, true),
  waktu_evaluasi: item.waktu_evaluasi ? formatDateTimeValue(item.waktu_evaluasi) : "",
  implementasi: Array.isArray(item.implementasi) ? item.implementasi.map((legacyImplementasi) => normalizeImplementasiItem(legacyImplementasi)) : [],
});
...
export default {
  ...
  methods: {
    ...
    async onSubmitImplementasi() {
      ...
      const endpoint = this.implementasiFormMode === "create" ? "implementasi_keperawatan_rinap/registerV2" : "implementasi_keperawatan_rinap/updateV2";
    ...
    async onSubmitEvaluasi() {
      ...
      const endpoint = this.evaluasiFormMode === "create" ? "evaluasi_keperawatan_rinap/registerV2" : "evaluasi_keperawatan_rinap/updateV2";
    ...
    async selectRegistrasi(e = {}, moveToList = true) {
      ...
      await Promise.allSettled([this.getImplementasiKeperawatanV2(), this.getLegacyEvaluasiKeperawatan(), this.initAssesmenTambahan(this.registrasi_id)]);
    },
  },
};
</script>
