  ...
  <div class="w-100">
    <tas-base-crud ref="crud-lab_regis" :config="buildConfig" @after-create="handleAfterCreate" :classes="registrasi_id ? '-' : 'container-fluid'" :filterView="filterView" :hideFilter="hideFilter" :hideGlobalSearch="hideGlobalSearch" :mockSlave="false">
      ...
      <template v-slot:list-table-action="rowData">
        ...
        <button class="btn btn-success mr-1" @click="goToPengambilanSampel(rowData.rowData)">
          <i class="ri-contrast-drop-2-line"></i> Pengambilan Sampel
        </button>
      ...
      <template v-slot:detail-footer="rowData">
        ...
        <div class="alert alert-custom alert-light-warning fade show mb-5" role="alert" v-if="rowData.rowData && rowData.rowData.registrasi_id && rowData.rowData.status < 1">
          ...
          <div class="alert-text">
            Mulai proses permintaan laboratorium?
          </div>
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="d-flex flex-column flex-grow-1 ml-3">
              ...
              <span class="text-muted font-weight-bold">
                  Buat koneksi request ke server sysmex
              </span>
          </div>
      ...
      <div class="mb-3">
        <div class="d-flex align-items-center">
          ...
          <div class="d-flex flex-column flex-grow-1 ml-3">
              ...
              <span class="text-muted font-weight-bold">
                  Ambil hasil dari server sysmex
              </span>
          </div>
      ...
      <div class="mb-3">
        <div class="d-flex align-items-center">
          ...
          <div class="d-flex flex-column flex-grow-1 ml-3">
              ...
              <span class="text-muted font-weight-bold">
                Buat koneksi request ke server LICA
              </span>
          </div>
      ...
      <div class="mb-3">
        <div class="d-flex align-items-center">
          ...
          <div class="d-flex flex-column flex-grow-1 ml-3">
              ...
              <span class="text-muted font-weight-bold">
                Buat koneksi request ke server ELIMS
              </span>
          </div>
  ...
  methods: {
    ...
    useSubmitRegistration() {
      this.$_alert.confirm('Konfirmasi', 'Apakah anda yakin ingin menggunakan kunjungan ini?').then((res) => {
        if (res.isConfirmed) {
          this.$_api.update('lab_regis', { ...this.dataObject, id: this.dataObject.id_lab_regis, is_registrasi: true }).then((res) => {
            this.$refs['crud-lab_regis'].$children[1].getData();
    ...
    updateLabRegis(data) {
      this.$_api.update('lab_regis', { ...data, id: data.id_lab_regis }).then((res) => {
    ...
    updateStatus(data, status) {
      ...
      .then((x) => { 
        if(x.isConfirmed) {
          this.$_api.update('lab_regis', { ...data, id: data.id_lab_regis, status }).then(async (res) => {
            // Puasa
