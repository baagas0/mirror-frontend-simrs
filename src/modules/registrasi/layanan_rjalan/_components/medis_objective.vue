          ...
          <div class="row">
            <div class="col-6">
              <div class="row">
                ...
                <div class="col-12">
                  <s-input v-model="mData.keadaan_umum" :key="'keadaan_umum'" :id="'keadaan_umum'" :item="{
                    label: 'Keadaan Umum',
                    id: 'keadaan_umum',
                    data: 'keadaan_umum',
                    type: 'lookup-radio',
                    ...
                    param: {},
                  }" :disabled="objectDataAssesmen.is_validasi" :valuee="mData.keadaan_umum" />
                </div>
                <div class="col-6">
                  <s-input v-model="mData.sistolik" :item="{
                    ...
                    class: '',
                    validation: ['required'],
                  }" :disabled="objectDataAssesmen.is_validasi" :valuee="mData.sistolik" />
                </div>
                <div class="col-6">
                  <s-input v-model="mData.diastolik" :item="{
                    ...
                    class: '',
                    validation: ['required'],
                  }" :disabled="objectDataAssesmen.is_validasi" :valuee="mData.diastolik" />
                </div>
                <div class="col-6">
                  <s-input v-model="mData.nadi" :item="{
                    ...
                    class: '',
                    validation: ['required'],
                  }" :disabled="objectDataAssesmen.is_validasi" :valuee="mData.nadi" />
                </div>
                <div class="col-6">
                  <s-input v-model="mData.pernafasan" :item="{
                    ...
                    class: '',
                    validation: ['required'],
                  }" :disabled="objectDataAssesmen.is_validasi" :valuee="mData.pernafasan" />
                </div>
                <div class="col-6">
                  <s-input v-model="mData.suhu" :item="{
                    ...
                    class: '',
                    validation: ['required'],
                  }" :disabled="objectDataAssesmen.is_validasi" :valuee="mData.suhu" />
                </div>
                <div class="col-12">
                  ...
                  <div class="row bordered p-2" style="border: solid 1px #c8c8c8;">
                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center mb-2">
                      <img :src="'./static/img/icon/' + (mData.skrining_nyeri_pain_img || 'pain1') + '.png'" class=""
                        style="width: 75px !important;" alt="">
                    </div>
                    <div class="col-12">
                ...
                <div class="col-12" v-if="mData.skrining_nyeri === 'Ada'">
                  <s-input v-model="mData.keterangan_skrining_nyeri" :item="{
                    ...
                    class: '',
                    validation: [],
                  }" :disabled="objectDataAssesmen.is_validasi" :valuee="mData.keterangan_skrining_nyeri" />
                </div>
                <div class="col-12">
              ...
              <div class="row">
                ...
                <div class="col-12">
                  <s-input v-model="mData.kesadaran" :key="'kesadaran'" :id="'kesadaran'" :item="{
                    ...
                    param: {},
                  }" :disabled="objectDataAssesmen.is_validasi" :valuee="mData.kesadaran" />
                </div>
                <div class="col-12">
                  <s-input v-model="mData.tinggi_badan" :item="{
                    ...
                    class: '',
                    validation: ['required'],
                  }" :disabled="objectDataAssesmen.is_validasi" :valuee="mData.tinggi_badan" />
                </div>
                <div class="col-12">
                  <s-input v-model="mData.berat_badan" :item="{
                    ...
                    class: '',
                    validation: ['required'],
                  }" :disabled="objectDataAssesmen.is_validasi" :valuee="mData.berat_badan" />
                </div>
                <div class="col-12">
                ...
                <div class="col-12">
                  <s-input v-model="mData.lingkar_kepala" :item="{
                    ...
                    class: '',
                    validation: ['required'],
                  }" :disabled="objectDataAssesmen.is_validasi" :valuee="mData.lingkar_kepala" />
                </div>
                <div class="col-12">
