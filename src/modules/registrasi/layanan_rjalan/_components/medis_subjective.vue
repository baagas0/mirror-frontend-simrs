							...
							<div class="row no-gutters mb-5 nav nav-primary nav-pills gap-8">
								<div style="flex-grow: 1">
									<s-input v-model="mData.riwayat_penyakit_dahulu_pengobatan" :item="{
										...
										param: {},
									}" :valuee="mData.riwayat_penyakit_dahulu_pengobatan" />
								</div>
								<div style="flex-grow: 1">
									<s-input v-model="mData.riwayat_alergi" :item="{
										...
										param: {},
									}" @input="mData.riwayat_alergi === 'Tidak' ? mData.riwayat_pembedahan = 'Tidak' : ''" :valuee="mData.riwayat_alergi" />
									<s-input
										v-model="mData.riwayat_alergi_kfa_id"
										v-if="mData.riwayat_alergi == 'Ada'"
										:key="'riwayat_alergi_kfa_id'"
										:id="'riwayat_alergi_kfa_id'"
										:item="{
										label: 'Daftar KFA',
										id: 'riwayat_alergi_kfa_id',
										data: 'riwayat_alergi_kfa_id',
										type: 'lookup-radio',
										validation: ['required'],
										value: mData.riwayat_alergi_kfa_id,
										api: 'kfa/product',
										pointer: {
											label: 'name',
											code: 'map_id',
										...
										param: {
											search: mData.riwayat_alergi_kfa_id
										},
										}"
										:valuee="mData.riwayat_alergi_kfa_id"
										:disabled="objectDataAssesmen.is_validasi"
									/>
									<p v-if="mData.riwayat_alergi_kfa_id">Alergi: {{ mData.riwayat_alergi_kfa_id }}</p>
