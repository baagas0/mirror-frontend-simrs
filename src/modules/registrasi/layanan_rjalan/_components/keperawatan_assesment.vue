          ...
          <div class="row">
            <div class="col-12">
              <ul class="nav nav-tabs nav-tabs-line mb-5">
                <li class="nav-item">
                  <a class="nav-link pointer" @click="switchTab('keperawatan')"
                    :class="{ 'active': tabActive === 'keperawatan' }">
              ...
              <div class="row">
                <div class="col-6">
                  <div class="w-100 d-flex justify-content-start gap-10">
                    <s-input v-model="fData.diagnosa_keperawatan" class="w-100" :key="'diagnosa_keperawatan'" :id="'diagnosa_keperawatan'" :item="{
                      ...
                      param: {},
                    }" :disabled="objectDataAssesmen.is_validasi" :valuee="fData.diagnosa_keperawatan" />
                ...
                <div class="col-12">
                  <s-input v-model="fData.subjective" :key="'subjective'" :id="'subjective'" :item="{
                    label: 'Subjective',
                    id: 'subjective',
                    data: 'subjective',
                    type: 'text',
                    ...
                    param: {},
                  }" :disabled="objectDataAssesmen.is_validasi" :valuee="fData.subjective" />
                </div>
                <div class="col-12">
      ...
      <b-modal ref="modal-form-diagnosa-keperawatan" id="modal-form-diagnosa-keperawatan" :centered="true" :hide-footer="true" :hide-header="true" :size="'md'">
        ...
        <ValidationObserver v-slot="{ handleSubmit }">
          <form ref="formDiagnosaKeperawatan" @submit.prevent="handleSubmit(onSubmitFormDiagnosaKeperawatan)" autocomplete="off">
            <div class="row">
              <div class="col-12">
                <s-input v-model="formDiagnosaKeperawatan.kode_diagnosa" :key="'kode_diagnosa'" :id="'kode_diagnosa'" :item="{
                  label: 'Kode Diagnosa',
                  id: 'kode_diagnosa',
                  data: 'kode_diagnosa',
                  type: 'text',
              ...
              <div class="col-12">
                <s-input v-model="formDiagnosaKeperawatan.nama_diagnosa" :key="'nama_diagnosa'" :id="'nama_diagnosa'" :item="{
                  label: 'Nama Diagnosa',
                  id: 'nama_diagnosa',
                  data: 'nama_diagnosa',
                  type: 'text',
              ...
              <div class="col-12">
                <button type="button" class="btn btn-light-secondary text-dark mr-3" @click="$bvModal.hide('modal-form-diagnosa-keperawatan')">
                  Tutup
                </button>
    ...
    onSubmitFormDiagnosaKeperawatan() {
      this.$_alert.confirm('Simpan data', 'apakah anda yakin ingin menyimpan data?').then((status) => {
        if (status.isDismissed) return
          ...
          this.$_api.create('diagnosa_keperawatan', this.formDiagnosaKeperawatan).then((res) => {
