                    ...
                    <tbody>
                        <tr>
                            <td style="vertical-align: middle;border-bottom: 1px solid #333;padding-top: 5mm;padding-bottom: 5mm;border-top: 1px solid #333">
                                ...
                                <h6 style="text-align: center;font-size: 14pt;"><strong><span>{{ item.final_aturan_pakai ? item.final_aturan_pakai : 'Sesudah/Sebelum Makan' }}</span></strong></h6>
                            </td>
                        </tr>
                    </tbody>
                </table>
                  ...
                  <tbody>
                      <tr>
                          <td style="vertical-align: middle;border-bottom: 1px solid #333;padding-top: 5mm;padding-bottom: 5mm;border-top: 1px solid #333">
                              ...
                              <h6 style="text-align: center;font-size: 14pt;"><strong><span>{{ item.aturan_pakai ? item.aturan_pakai : 'Sesudah/Sebelum Makan' }}</span></strong></h6>
                          </td>
                      </tr>
                  </tbody>
              </table>
