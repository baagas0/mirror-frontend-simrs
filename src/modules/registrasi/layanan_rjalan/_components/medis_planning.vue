      ...
      <div class="accordion accordion-solid accordion-toggle-plus">
        ...
        <div class="card">
          <div class="card-header">
            <div class="card-title collapsed">Kontrol</div>
          </div>
          <div class="card-body">
                ...
                <div class="row">
                  <div class="col-3">
                    <s-input
                      ...
                      :valuee="fDiet.diet_type" />
                  </div>
                  <div class="col-3">
                    <s-input
                      v-model="fDiet.diet_nutrient"
                      :key="'diet_nutrient'"
                      :id="'diet_nutrient'"
                      :item="{
                      ...
                      :disabled="objectDataAssesmen.is_validasi"
                      :valuee="fDiet.diet_nutrient" />
                  </div>
                  <div class="col-3">
                    <s-input
                      v-model="fDiet.diet_exclude_food_nutrient"
                      :key="'diet_exclude_food_nutrient'"
                      ...
                      :disabled="objectDataAssesmen.is_validasi"
                      :valuee="fDiet.diet_exclude_food_nutrient" />
                  </div>
                  <div class="col-3">
                    <s-input
                      v-model="fDiet.diet_keterangan"
                      :key="'diet_keterangan'"
                      :id="'diet_keterangan'"
                      :item="{
                        label: 'Keterangan',
              ...
              <div class="col-12">
                <b-form-group label="Kontrol:" v-slot="{ ariaDescribedby }">
                  <b-form-radio-group
                    ...
                    @change="handleKontrolChange"></b-form-radio-group>
                </b-form-group>
              </div>
            </div>
          </div>
