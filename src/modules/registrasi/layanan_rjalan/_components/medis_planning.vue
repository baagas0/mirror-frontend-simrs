<template>
      ...
      <div class="card-body p-4">
        <div class="accordion accordion-solid accordion-toggle-plus">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <!-- Form untuk menambah diet -->
              <ValidationObserver v-slot="{ handleSubmit }">
                <form @submit.prevent="handleSubmit(onSubmitEvaluasiDiet)" autocomplete="off">
                  <div class="row">
                    <div class="col-3">
                      <s-input v-model="fDiet.diet_type" :key="'diet_type'" :id="'diet_type'" :item="{
                        label: 'Jenis Diet',
                        id: 'diet_type',
                        data: 'diet_type',
                        type: 'lookup-radio',
                        validation: ['required'],
                        value: fDiet.diet_type,
                        pointer: {
                          label: 'label',
                          code: 'code',
                          display: ['label'],
                          list: [
                            { label: 'Anjuran peningkatan cairan', code: '113148007|Anjuran peningkatan cairan' },
                            { label: 'Diet rendah garam', code: '226208002|Diet rendah garam' },
                            { label: 'Diet rendah lemak', code: '226211005|Diet rendah lemak' },
                            { label: 'Diet rendah gula', code: '226210006|Diet rendah gula' },
                            { label: 'Diet tinggi protein', code: '226209005|Diet tinggi protein' },
                            { label: 'Diet diabetes', code: '226212003|Diet diabetes' },
                            { label: 'Diet penurunan berat badan', code: '226213008|Diet penurunan berat badan' },
                            { label: 'Diet penambahan berat badan', code: '703977005|Diet penambahan berat badan' },
                            { label: 'Diet tinggi serat', code: '226215001|Diet tinggi serat' },
                            { label: 'Diet cair', code: '225373002|Diet cair' },
                            { label: 'Diet lunak', code: '225372007|Diet lunak' },
                            { label: 'Diet bubur / lumat', code: '225374008|Diet bubur / lumat' },
                          ]
                        },
                        param: {},
                      }" :disabled="objectDataAssesmen.is_validasi" :valuee="fDiet.diet_type" />
                    </div>
                    <div class="col-3">
                      <s-input v-model="fDiet.diet_nutrient" :key="'diet_nutrient'" :id="'diet_nutrient'" :item="{
                        label: 'Nutrisi / Nutrien',
                        id: 'diet_nutrient',
                        data: 'diet_nutrient',
                        type: 'lookup-radio',
                        validation: ['required'],
                        value: fDiet.diet_nutrient,
                        pointer: {
                          label: 'label',
                          code: 'code',
                          display: ['label'],
                          list: [
                            { label: 'Air mineral', code: '444695006|Air mineral' },
                            { label: 'Karbohidrat', code: '226356002|Karbohidrat' },
                            { label: 'Protein', code: '226358001|Protein' },
                            { label: 'Lemak', code: '226359009|Lemak' },
                            { label: 'Natrium', code: '226360004|Natrium' },
                            { label: 'Vitamin', code: '226357006|Vitamin' },
                            { label: 'Cairan', code: '226361000|Cairan' },
                          ]
                        },
                        param: {},
                      }" :disabled="objectDataAssesmen.is_validasi" :valuee="fDiet.diet_nutrient" />
                    </div>
                    <div class="col-3">
                      <s-input v-model="fDiet.diet_exclude_food_nutrient" :key="'diet_exclude_food_nutrient'" :id="'diet_exclude_food_nutrient'" :item="{
                        label: 'Larangan Makanan / Minuman',
                        id: 'diet_exclude_food_nutrient',
                        data: 'diet_exclude_food_nutrient',
                        type: 'lookup-radio',
                        validation: ['required'],
                        value: fDiet.diet_exclude_food_nutrient,
                        pointer: {
                          label: 'label',
                          code: 'code',
                          display: ['label'],
                          list: [
                            { label: 'Soft drink (Minuman bersoda)', code: '1296980001|Soft drink (Minuman bersoda)' },
                            { label: 'Fast food (Makanan cepat saji)', code: '227415009|Fast food (Makanan cepat saji)' },
                            { label: 'Fried food (Makanan gorengan)', code: '227416005|Fried food (Makanan gorengan)' },
                            { label: 'Processed meat (Daging olahan)', code: '227417001|Processed meat (Daging olahan)' },
                            { label: 'High sugar food (Makanan tinggi gula)', code: '227418006|High sugar food (Makanan tinggi gula)' },
                            { label: 'Salty snack (Makanan tinggi garam)', code: '227419003|Salty snack (Makanan tinggi garam)' },
                            { label: 'Caffeinated drink (Minuman berkafein)', code: '227420009|Caffeinated drink (Minuman berkafein)' },
                            { label: 'Alcoholic beverage (Minuman beralkohol)', code: '227421008|Alcoholic beverage (Minuman beralkohol)' },
                          ]
                        },
                        param: {},
                      }" :disabled="objectDataAssesmen.is_validasi" :valuee="fDiet.diet_exclude_food_nutrient" />
                    </div>
                    <div class="col-3">
                      <s-input v-model="fDiet.diet_keterangan" :key="'diet_keterangan'" :id="'diet_keterangan'" :item="{
                        label: 'Keterangan',
                        id: 'diet_keterangan',
                        data: 'diet_keterangan',
                        type: 'text',
                        validation: ['required'],
                        value: fDiet.diet_keterangan,
                        param: {},
                      }" :disabled="objectDataAssesmen.is_validasi" :valuee="fDiet.diet_keterangan" />
                    </div>
                    <div class="col-12 align-self-center mt-3">
                      <button type="reset" class="btn btn-light-danger mr-3" @click="resetFormDiet()">
                    ...
                    <table class="table table-bordered">
                      <thead>
                        <tr>
                          <th>#</th>
                          <th>Jenis Diet</th>
                          <th>Nutrisi / Nutrien</th>
                          <th>Larangan Makanan / Minuman</th>
                          <th>Keterangan</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr v-for="(item, i) in mData.diet" :key="'table-diet'+i">
                          <td>
                            <a href="#" @click="onDelete(i, 'diet')" class="btn btn-sm btn-light-danger font-weight-bold mr-2" :class="{ 'disabled': objectDataAssesmen.is_validasi }">
                              <i class="ri-delete-bin-line"></i>
                            </a>
                          </td>
                          <td>{{ item.diet_type || '-' }}</td>
                          <td>{{ item.diet_nutrient || '-' }}</td>
                          <td>{{ item.diet_exclude_food_nutrient || '-' }}</td>
                          <td>{{ item.diet_keterangan || '-' }}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
              ...
              <!-- Radio Kontrol tetap dipertahankan -->
              <div class="row mt-5">
                <div class="col-12">
                  <hr>
                </div>
                <div class="col-12">
                  <b-form-group label="Kontrol:" v-slot="{ ariaDescribedby }">
                    <b-form-radio-group
                      size="lg"
                      id="radio-group-1"
                      v-model="mData.tindak_lanjut_kontrol"
                      :options="[
                        { text: 'Tidak perlu kontrol', value: 'tidak_perlu_kontrol' },
          ...
          <div class="card">
            <div class="card-header" @click="accordionActive = accordionActive === 'procedure' ? '' : 'procedure'">
              <div class="card-title" :class="{ 'collapsed': accordionActive !== 'procedure' }">
                  Prosedur
              </div>
            </div>
              ...
              <div class="card-body">
                <ValidationObserver v-slot="{ handleSubmit }">
                  <form @submit.prevent="handleSubmit(onSubmitEvaluasiProcedure)" autocomplete="off">
                    <div class="row">
                      <div class="col-4">
                        <s-input v-model="fProcedure.tipe_procedure" :key="'tipe_procedure'" :id="'tipe_procedure'" :item="{
                          ...
                          param: {},
                        }" :disabled="objectDataAssesmen.is_validasi" :valuee="fProcedure.tipe_procedure" />
                      </div>
                      <div class="col-4">
                        <s-input v-model="fProcedure.tindakan" :key="'tindakan'" :id="'tindakan'" :item="{
                          ...
                          param: {},
                        }" :disabled="objectDataAssesmen.is_validasi" :valuee="fProcedure.tindakan" />
                      </div>
                      <div class="col-4">
                        <s-input v-model="fProcedure.qty" :key="'qty'" :id="'qty'" :item="{
                          label: 'Quantity',
                          id: 'qty',
                          data: 'qty',
                          type: 'number',
                          ...
                          param: {},
                        }" :disabled="objectDataAssesmen.is_validasi" :valuee="fProcedure.qty" />
                      </div>
                      <!-- <div class="col-6">
                      ...
                      <div class="col-6" v-if="fProcedure.tipe_procedure === 'ICD'">
                        <s-input v-model="fProcedure.procedure" :key="'procedure'" :id="'procedure'" :item="{
                          ...
                          param: {},
                        }" :disabled="objectDataAssesmen.is_validasi" :valuee="fProcedure.procedure_medis" />
                      </div>
                      ...
                      <div class="col-6">
                        <s-input v-model="fProcedure.keterangan" :key="'keterangan'" :id="'keterangan'" :item="{
                          ...
                          param: {},
                        }" :disabled="objectDataAssesmen.is_validasi" :valuee="fProcedure.keterangan" />
                      </div>
                      ...
                      <table class="table table-bordered">
                        ...
                        <tbody>
                          <tr v-for="(item, i) in mData.prosedur" :key="'table-prosedur'+i">
                            ...
                            <td>{{ typeof item.procedure == 'object' ? (item.procedure && item.procedure.nama_prosedur ? `${item.procedure.kode_prosedur} - ${item.procedure.nama_prosedur}` : '-') : item.procedure }}</td>
          ...
          <div class="card">
            <div class="card-header" @click="accordionActive = accordionActive === 'obat' ? '' : 'obat'">
              <div class="card-title" :class="{ 'collapsed': accordionActive !== 'obat' }">
                  Obat
              </div>
            </div>
                ...
                <div class="row">
                  <div class="col-12">
                    <ul class="nav nav-tabs nav-tabs-line mb-5">
                      <li class="nav-item">
                        <a class="nav-link pointer" @click="switchTab('obat_jadi')"
                          :class="{ 'active': tabActive === 'obat_jadi' }">
                          <span class="nav-icon"><i class="flaticon2-chat-1"></i></span>
                          <span class="nav-text">Obat Jadi</span>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link pointer" @click="switchTab('obat_racikan')"
                          :class="{ 'active': tabActive === 'obat_racikan' }">
                          <span class="nav-icon"><i class="flaticon2-chat-1"></i></span>
                        ...
                        <div class="col-12">
                          <div class="row">
                            ...
                            <div class="col-12">
                              <div class="row">
                                <div class="col-6">
                                  <div class="row">
                                    <div class="col-12">
                                      <s-input v-model="fData.jumlah" :key="'jumlah'" :id="'jumlah'" :item="{
                                        label: 'Jumlah',
                                        id: 'jumlah',
                                        data: 'jumlah',
                                        hint: '',
                                        ...
                                        value: fData.jumlah,
                                        param: {},
                                      }" :disabled="objectDataAssesmen.is_validasi" :valuee="fData.jumlah" />
                                    </div>
                                    <div class="col-12">
                                      <s-input v-model="fData.signa" :key="'signa'" :id="'signa'" :item="{
                                        label: 'Signa',
                                        id: 'signa',
                                        data: 'signa',
                                        hint: '',
                                        ...
                                        value: fData.signa,
                                        param: {},
                                      }" :disabled="objectDataAssesmen.is_validasi" :valuee="fData.signa" />
                                    </div>
                                    <div class="col-6">
                                      <s-input v-model="fData.aturan_pakai" :key="'aturan_pakai'" :id="'aturan_pakai'" :item="{
                                        ...
                                        param: {},
                                      }" :disabled="objectDataAssesmen.is_validasi" :valuee="fData.aturan_pakai" />
                                    </div>
                                  </div>
                                </div>
                                <div class="col-6">
                                  <div class="row">
                                    <div class="col-12">
                                      <!-- <s-input v-model="fData.satuan_jual" :key="'satuan_jual'" :id="'satuan_jual'" :item="{
                                        label: 'Satuan',
                                        id: 'satuan_jual',
                                        data: 'satuan_jual',
                                        hint: '',
                                        ...
                                        param: {},
                                      }" :disabled="objectDataAssesmen.is_validasi" :valuee="fData.satuan_jual" /> -->
                                      <s-input v-model="fData.satuan_jual" :key="'satuan_jual'" :id="'satuan_jual'" :item="{
                                        label: 'Satuan',
                                        id: 'satuan_jual',
                                        data: 'satuan_jual',
                                    ...
                                    <div class="col-12">
                                      <!-- <s-input v-model="fData.satuan_pakai" :key="'satuan_pakai'" :id="'satuan_pakai'" :item="{
                                        label: 'Satuan Pakai',
                                        id: 'satuan_pakai',
                                        data: 'satuan_pakai',
                                        hint: '',
                                        ...
                                        param: {},
                                      }" :disabled="objectDataAssesmen.is_validasi" :valuee="fData.satuan_pakai" /> -->
                                      <s-input v-model="fData.satuan_pakai" :key="'satuan_pakai'" :id="'satuan_pakai'" :item="{
                                        label: 'Satuan Pakai',
                                        id: 'satuan_pakai',
                                        data: 'satuan_pakai',
                                    ...
                                    <div class="col-12">
                                      <s-input v-model="fData.signa_manual" :key="'signa_manual'" :id="'signa_manual'" :item="{
                                        label: 'Signa Manual',
                                        id: 'signa_manual',
                                        data: 'signa_manual',
                                        hint: '',
                                        ...
                                        param: {},
                                      }" :disabled="objectDataAssesmen.is_validasi" :valuee="fData.signa_manual" />
                                    </div>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div class="col-12 align-self-center">
                              ...
                              <button type="submit" class="btn btn-light-primary mr-3" :disabled="is_validasi || isSubmitting">
                                <i class="ri-save-line"></i>
                                {{ $t('global.submit') }}
                              </button>
                            </div>
                  ...
                  <form ref="assesmenForm" @submit.prevent="handleSubmit(onSubmitEvaluasiObatRacik)" autocomplete="off">
                    <div class="row">
                      <div class="col-12">
                        <div class="row">
                          <div class="col-12">
                            <s-input v-model="fDataObatRacik.nama_obat" :key="'nama_obat'" :id="'nama_obat'" :item="{
                              label: 'Nama Obat',
                              id: 'nama_obat',
                              data: 'nama_obat',
                              type: 'text',
                              ...
                              param: {},
                            }" :disabled="objectDataAssesmen.is_validasi" :valuee="fDataObatRacik.nama_obat" />
                          </div>
                          <div class="col-6">
                            <s-input v-model="fDataObatRacik.signa" :key="'signa'" :id="'signa'" :item="{
                              label: 'Signa',
                              id: 'signa',
                              data: 'signa',
                              hint: '',
                              ...
                              param: {},
                            }" :disabled="objectDataAssesmen.is_validasi" :valuee="fDataObatRacik.signa" />
                          </div>
                          <div class="col-6">
                            <s-input v-model="fDataObatRacik.jumlah" :key="'jumlah'" :id="'jumlah'" :item="{
                              label: 'Jumlah',
                              id: 'jumlah',
                              data: 'jumlah',
                              hint: '',
                              ...
                              param: {},
                            }" :disabled="objectDataAssesmen.is_validasi" :valuee="fDataObatRacik.jumlah" />
                          </div>
                          <div class="col-6">
                            <s-input v-model="fDataObatRacik.aturan_pakai" :key="'aturan_pakai'" :id="'aturan_pakai'" :item="{
                              label: 'Aturan Pakai',
                              id: 'aturan_pakai',
                              data: 'aturan_pakai',
                              type: 'lookup-radio',
                              ...
                              param: {},
                            }" :disabled="objectDataAssesmen.is_validasi" :valuee="fDataObatRacik.aturan_pakai" />
                          </div>
                          <div class="col-6">
          ...
          <div class="card">
            <div class="card-header" @click="accordionActive = accordionActive === 'fisioterapi' ? '' : 'fisioterapi'">
              <div class="card-title" :class="{ 'collapsed': accordionActive !== 'fisioterapi' }">
                  Fisioterapi
              </div>
            </div>
            <div class="collapse" :class="{ 'show': accordionActive === 'fisioterapi' }">
              <div class="card-body">
                <ValidationObserver v-slot="{ handleSubmit }">
                  <form @submit.prevent="handleSubmit(onSubmitFisioterapi)" autocomplete="off">
                    <div class="row">
                      ...
                      <div class="col-12">
                        <s-input v-model="fFisioterapi.tanggal" :item="{
                          label: 'Tanggal',
                          id: 'tanggal',
                          data: 'tanggal',
                          type: 'datetime',
                          ...
                          param: {},
                        }" :disabled="objectDataAssesmen.is_validasi" :valuee="fFisioterapi.tanggal" />
                      </div>

                      <div class="col-6">
                        <s-input v-model="fFisioterapi.intervensi" :item="{
                          label: 'Intervensi',
                          id: 'intervensi',
                          data: 'intervensi',
                          type: 'textarea',
                          ...
                          param: {},
                        }" :disabled="objectDataAssesmen.is_validasi" :valuee="fFisioterapi.intervensi" />
                      </div>

                      <div class="col-6">
                        <s-input v-model="fFisioterapi.area_terapi" :item="{
                          ...
                          param: {},
                        }" :disabled="objectDataAssesmen.is_validasi" :valuee="fFisioterapi.area_terapi" />
                      </div>
                ...
                <div class="row">
                  <div class="col-12">
                    <s-input v-model="mData.evaluasi_fisioterapi" :item="{
                      label: 'Evaluasi',
                      ...
                      param: {},
                    }" :disabled="objectDataAssesmen.is_validasi" :valuee="mData.evaluasi_fisioterapi" />
                  </div>

                  <div class="col-12">
                    <button type="submit" class="btn btn-light-primary mr-3 w-100"
  ...
  export default {
    name: 'medis_planning',
    components: { MedisPlanningObatRacik },
    props: {
      is_validasi: {
        type: Boolean,
        required: true,
    ...
    data() {
      return {
        ...
        fDataObatRacik: { // ini buat obat racik
          kronis: false,
          obat_jadi: [],
        },
    ...
    watch: {
      ...
      // 'mData.tindak_lanjut_kontrol': {
      //   deep: true,
      //   immediate: false,
      //   handler(to, from) {
      //     this.handleKontrolChange()
      //   }
      // },
      'fData.nama_obat': {
        deep: true,
        ...
        handler(to, from) {
          ...
          if (this.fData.nama_obat && this.fData.nama_obat.nama_satuan_jual) {
            // this.fData.satuan_jual = this.fData.nama_obat.nama_satuan_jual
            // this.fData.satuan_pakai = this.fData.nama_obat.nama_satuan_jual
          }
        }
      },
      'fProcedure.tindakan': {
    ...
    methods: {
      ...
      handleData() {
        ...
        if (!this.mData.diet) this.mData.diet = []
      },
      switchTab(key) {
        this.tabActive = key
      ...
      onSubmitEvaluasiObatRacik() {
        console.log('onSubmitEvaluasiObatRacik 123')
        this.isSubmitting = true

        localStorage.setItem('medis_planning_accordion', 'obat')
        localStorage.setItem('medis_planning_accordion_tab_active', 'obat_racikan')
        console.log('fDataObatRacikIndex', this.fDataObatRacikIndex)
        // return;

        if (this.fDataObatRacikIndex && this.fDataObatRacikIndex !== 'create') { 
      ...
      onSubmitEvaluasiProcedure() {
        ...
        this.$_api.post('penjualanJasa/register', paramPenjualanJasa).then((res) => {
      ...
      onSubmitEvaluasiDiet() {
        console.log('onSubmitEvaluasiDiet')

        // Initialize diet array if not exists
        if (!this.mData.diet) this.mData.diet = []

        // Push data diet ke array
        this.mData.diet.push(this.fDiet)

        // Emit untuk update parent
        this.$emit('submit', { key: 'planning', open_tab: 'planning', data: this.mData })
        ...
        // Success alert
        this.$_alert.success('Diet berhasil ditambahkan')
      },
      resetFormDiet() {
        this.fDiet = {}
      }
