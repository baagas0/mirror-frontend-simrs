        ...
        <div class="card body bg-light-primary pt-2 pb-2 pr-2 pl-2">
          <div class="row align-items-center">
            ...
            <div class="col-12 pl-6">
              <div class="row">
                <div class="col-12 mt-3" v-for="(item, a) in racik.resep_detail_rjalans" :key="'resep-racik-detail-obat-jadi'+a">
                              ...
                              <div class="row align-items-center">
                                ...
                                <div class="col-2 align-items-start" v-if="showChecklist">
                                  <label class="checkbox checkbox-outline checkbox-danger">
                                    <input type="checkbox" :name="'status_resep_detail_rjalan'+item.id" v-model="item.status_resep_detail_rjalan" :disabled="enableChecklist" :checked="item.status_resep_detail_rjalan"  @change="$parent.updateResepDetail(item)" />
                                    <span></span>
                                  </label>
                                </div>
                              </div>
