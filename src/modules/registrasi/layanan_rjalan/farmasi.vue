  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-xl-3 col-md-3 col-sm-12">
        <card-registrasi-rjalan @selected="selectRegistrasi" :type="'farmasi'"/>
      </div>
      <div class="col-xl-9 col-md-9 col-sm-12" v-if="oResep.id">
        <div class="card card-custom mb-5" v-if="dataRegistrasi">
      ...
      <template v-else>
        <div class="xl-8 col-md-8 col-sm-12">
...
<script>
  ...
  import FarmasiDraftDokter from './_components/farmasi_draft_dokter.vue'
  import FarmasiTelaah from './_components/farmasi_telaah.vue'
  import FarmasiPersiapan from './_components/farmasi_persiapan.vue'
  import FarmasiPengecekan from './_components/farmasi_pengecekan.vue'
  import FarmasiPenyerahan from './_components/farmasi_penyerahan.vue'
  
  import moment from 'moment'
  moment.locale('id')

  export default {
    name: 'layanan_rjalan_farmasi',
    components: { CardRegistrasiRjalan, FarmasiDraftDokter, FarmasiTelaah, FarmasiPersiapan, FarmasiPengecekan, FarmasiPenyerahan },
    data () {
      return {
        endpoint: 'resep_rjalan',
    ...
    methods: {
      ...
      findDetailResep () {
        this.$_api.post('resep_detail_rjalan/list', { resep_rjalan_id: this.oResep.id, is_racik: 0, page: 1, limit: 99999 }).then((res) => {
      ...
      createResep () {
        ...
        let param = {
          ...
          "tahap_resep": 0,
          penjualan_id: this.objectPenjualan.penjualan_id || null,
        }
      ...
      updateResep (data) {
        ...
        data.penjualan_id = this.objectPenjualan.penjualan_id || null;
      ...
      switchActiveTab (e) {
        if (this.dataChangeStatus) this.$_alert.confirm('Data belum disimpan!', 'Yakin ingin melanjutkan?').then((status) => {
            if (status.isDismissed) return
              ...
              // this.$set(this.dataResep, e , this.oResep.json_assesment_farmasi_rjalan[e])
              this.dataResep[e] = this.oResep.json_assesment_farmasi_rjalan[e]
