  ...
  <div class="card card-custom card-sticky">
    <div class="card-header">
      ...
      <div class="card-toolbar">
        <div class="btn-group">
          <button type="button" class="btn btn-primary" @click="$parent.updateAssesmen({key:'gcs', data:mData})" :disabled="objectDataAssesmen.is_validasi">
          ...
          <div class="row">
            ...
            <div class="col-12 d-flex justify-content-center" style="flex-grow: 1;">
              <s-input v-model="mData.usia" :key="'usia'" :id="'usia'" :item="{
                ...
                param: {},
              }" :disabled="is_validasi" :valuee="mData.usia" />
            </div>
  ...
  export default {
    ...
    mounted () {
      ...
      if (this.mData.gcs && this.mData.gcs.gcs_fields && this.mData.gcs.gcs_fields.length) {
        ...
        //     let data_gcs = fields.filter(x => x.key === i.key)
