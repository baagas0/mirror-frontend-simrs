            ...
            <div class="col-12">
              <div class="row">
                <div class="col-6" v-if="tabActive === 'keperawatan'">
                  <s-input v-model="fData.diagnosa_keperawatan" :item="{
                ...
                <div class="col-12" v-else-if="tabActive === 'kebidanan'">
                  <s-input v-model="fData.nama_diagnosa" :key="'nama_diagnosa'" :id="'nama_diagnosa'" :item="{
                    label: 'Diagnosa ' + tabActive.charAt(0).toUpperCase() + tabActive.slice(1),
                    id: 'nama_diagnosa',
                    data: 'nama_diagnosa',
                    type: 'text',
                    ...
                    param: {},
                  }" :disabled="objectDataAssesmen.is_validasi" :valuee="fData.nama_diagnosa" />
                </div>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              <tr v-for="(item, i) in mData[tabActive]" :key="'table'+tabActive+i">
                ...
                <td>{{ item.nama_diagnosa ? item.nama_diagnosa : ( item.diagnosa_keperawatan && item.diagnosa_keperawatan.nama_diagnosa ? item.diagnosa_keperawatan.nama_diagnosa : '-' ) }}</td>
                <!-- <td></td> -->
