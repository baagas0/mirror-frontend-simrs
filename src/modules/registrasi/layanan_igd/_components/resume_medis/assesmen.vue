<template>
	<b-card no-body class="card-custom mb-1" style="border-radius: 10px 10px 0px 0px;">
		<b-card-header header-tag="div" class="p-1" role="tab" v-b-toggle.accordion-assesmen style="min-height: 0px; background-color: #87bf6d; border-radius: 10px 10px 0px 0px;">
		...
		<b-collapse id="accordion-assesmen" v-model="collapse" accordion="accordion-assesmen" role="tabpanel">
			<b-card-body>
				<div class="row">
					<div class="col-12">
						<b-card no-body class="card-custom mb-1" style="border-radius: 10px 10px 0px 0px;">
							<b-card-header header-tag="div" class="p-1" role="tab" v-b-toggle.accordion-assesmen-diagnosa style="min-height: 0px; background-color: #bfb36d; border-radius: 10px 10px 0px 0px;">
								<div class="card-title" style="padding: 0.7rem 1rem;">
									<h4 class="card-label">
										Diagnosa
									</h4>
              					...
              					<form @submit.prevent="handleSubmit(submitDiagnosa)" autocomplete="off">
										...
										<div class="col-12">
											<table class="table table-bordered">
												...
												<tbody>
													<tr v-for="(item, i) in mData.diagnosa" :key="'table-diagnosa-'+i">
														<td>              
