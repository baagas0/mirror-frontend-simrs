                            ...
                            <div class="col-12">
                              <div class="row">
                                <div class="col-6">
                                  <div class="row">
                                    <div class="col-12">
                                      <s-input v-model="fObatJadi.jumlah" :key="'jumlah'" :id="'jumlah'" :item="{
                                        label: 'Jumlah',
                                        id: 'jumlah',
                                        data: 'jumlah',
                                        hint: '',
                                    ...
                                    <div class="col-12">
                                      <s-input v-model="fObatJadi.signa" :key="'signa'" :id="'signa'" :item="{
                                        label: 'Signa',
                                        id: 'signa',
                                        data: 'signa',
                                        hint: '',
                                ...
                                <div class="col-6">
                                  <div class="row">
                                    <div class="col-12">
                                      <s-input v-model="fObatJadi.satuan_jual" :key="'satuan_jual'" :id="'satuan_jual'" :item="{
                                        label: 'Satuan Jual',
                                        id: 'satuan_jual',
                                        data: 'satuan_jual',
                                        hint: '',
                                    ...
                                    <div class="col-12">
                                      <s-input v-model="fObatJadi.satuan_pakai" :key="'satuan_pakai'" :id="'satuan_pakai'" :item="{
                                        label: 'Satuan Pakai',
                                        id: 'satuan_pakai',
                                        data: 'satuan_pakai',
                                        hint: '',
                                    ...
                                    <div class="col-12">
                                      <s-input v-model="fObatJadi.signa_manual" :key="'signa_manual'" :id="'signa_manual'" :item="{
                                        label: 'Signa Manual',
                                        id: 'signa_manual',
                                        data: 'signa_manual',
                                        hint: '',
