<template>
	<b-card no-body class="card-custom mb-1" style="border-radius: 10px 10px 0px 0px;">
		<b-card-header header-tag="div" class="p-1" role="tab" v-b-toggle.pemeriksaan-vital style="min-height: 0px; background-color: #87bf6d; border-radius: 10px 10px 0px 0px;">
		...
		<b-collapse id="pemeriksaan-vital" v-model="collapse" accordion="accordion-pemeriksaan-vital" role="tabpanel">
			<b-card-body>
				<div class="row">
					<div class="col-6">
						<div class="row">
								...
								<div class="col-6">
									<s-input v-model="mData.sp02" :item="{
										label: 'SP02',
										id: 'sp02',
										data: 'sp02',
										value: mData.sp02,
								...
								<div class="col-6">
									<s-input v-model="mData.pupil" :item="{
										label: 'Pupil',
										id: 'pupil',
										data: 'pupil',
										value: mData.pupil,
				...
				<div class="col-6">
						<div class="row">
								...
								<div class="col-12">
									<s-input v-model="mData.reaksi_cahaya" :key="'reaksi_cahaya'" :id="'reaksi_cahaya'" :item="{
										label: 'Reaksi Cahaya',
										id: 'reaksi_cahaya',
										data: 'reaksi_cahaya',
										type: 'lookup-radio',
										validation: [],
										value: mData.reaksi_cahaya,
										pointer: {
											label: 'label',
											code: 'code',
											display: ['label'],
											list: [
												{ label: 'isokor', code: 'isokor' },
												{ label: 'anisokor', code: 'anisokor' },
											]
										},
										param: {},
									}" :valuee="mData.reaksi_cahaya" />
								</div>
								<div class="col-12">
