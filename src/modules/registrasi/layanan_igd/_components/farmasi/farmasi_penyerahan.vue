                      ...
                      <div class="row align-items-center">
                        ...
                        <div class="col-2 align-items-start">
                          <label class="checkbox checkbox-outline checkbox-danger">
                            <input type="checkbox" :name="'status_resep_detail_igd'+item.id" v-model="item.status_resep_detail_igd" :disabled="oResep.tahap_resep > 4" :checked="item.status_resep_detail_igd"  @change="updateResepDetail(item)" />
                            <span></span>
                          </label>
                        </div>
                      </div>
