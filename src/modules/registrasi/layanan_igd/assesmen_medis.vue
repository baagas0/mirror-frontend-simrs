            ...
            <div class="d-flex flex-row justify-content-between align-items-center">
              <div>
                ...
                <SatuSehat
                  ...
                  :heart_rates="[
                    {
                      value: dataAssesmen.objective.nadi,
          ...
          <div class="card card-custom">
            <div class="card-body text-center">
              ...
              <button
                ...
                v-if="info_alert.includes('Assesmen keperawatan')"
                @click="
                  $router.push({
...
export default {
  ...
  methods: {
    async selectRegistrasi(e, switch_tab = true) {
      ...
      let dataKeperawatan = await this.$_api.list("assesment_keperawatan_igd", {
