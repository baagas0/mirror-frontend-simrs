            ...
            <div class="card-body ribbon ribbon-right">
              ...
              <div class="d-flex flex-row justify-content-between align-items-center">
                <div>
                  ...
                  <p class="text-muted mb-0 font-weight-bold font-size-sm">Tanggal Kedatangan: {{ objectTriage.tanggal_kedatangan | parse("date") || "-" }}</p>
                  <p class="text-muted mb-0 font-weight-bold font-size-sm">Jam Kedatangan: {{ objectTriage.jam_kedatangan || "-" }}</p>
                  <p class="text-muted mb-0 font-weight-bold font-size-sm">Jam Mulai Pemeriksaan: {{ objectTriage.jam_mulai_pemeriksaan || "-" }}</p>
                  <p class="text-muted mb-0 font-weight-bold font-size-sm">Petugas: {{ objectTriage.username_petugas || "-" }}</p>
            ...
            <template v-if="state.includes('form')">
              <div class="card card-custom">
                <div class="card-header">
                  <h3 class="card-title">Buat Triage Layanan IGD</h3>
                      ...
                      <div class="card-body">
                        <div class="form-group mb-8">
                          <div class="alert alert-custom alert-default" role="alert">
                            ...
                            <div class="alert-text">Isi form dibawah ini untuk membuat triage layanan IGD.</div>
                          </div>
                        </div>

                        <div class="col-12" v-if="state === 'form-create'">
                          <s-input
                            v-model="objectTriage.input_source"
                            :item="{
                              label: 'Data Dari?',
                              id: 'input_source',
                              data: 'input_source',
                        ...
                        <div class="col-12">
                          <s-input
                            v-model="objectTriage.tgl_lahir"
                            :key="'tgl_lahir'"
                            :id="'tgl_lahir'"
                            :item="{
                              label: 'Tanggal Lahir',
                        ...
                        <div class="col-12">
                          <s-input
                            v-model="objectTriage.tanggal_kedatangan"
                            :key="'tanggal_kedatangan'"
                            ...
                            :item="{
                              ...
                              type: 'date',
                              validation: ['required'],
                              value: objectTriage.tanggal_kedatangan,
                              param: {},
                            }"
                            :valuee="objectTriage.tanggal_kedatangan" />
                        </div>

                        <div class="col-12">
                          <s-input
                            v-model="objectTriage.jam_kedatangan"
                            :key="'jam_kedatangan'"
                            :id="'jam_kedatangan'"
                            :item="{
                              ...
                              type: 'time',
                              validation: ['required'],
                              value: objectTriage.jam_kedatangan,
                              param: {},
                            }"
                            :valuee="objectTriage.jam_kedatangan" />
                        </div>

                        <div class="col-12">
                          <s-input
                            v-model="objectTriage.jam_mulai_pemeriksaan"
                            :key="'jam_mulai_pemeriksaan'"
                            :id="'jam_mulai_pemeriksaan'"
                            :item="{
                              label: 'Jam Mulai Pemeriksaan',
                              id: 'jam_mulai_pemeriksaan',
                              data: 'jam_mulai_pemeriksaan',
                              type: 'time',
                              validation: [],
                              value: objectTriage.jam_mulai_pemeriksaan,
                              param: {},
                            }"
                            :valuee="objectTriage.jam_mulai_pemeriksaan" />
                        </div>
                      </div>
              ...
              <td colspan="3">
                <table class="custom-table">
                  ...
                  <tr>
                    ...
                    <td>:</td>
                    <td>{{ objectTriage.tanggal_kedatangan | parse("date") || "-" }}</td>
                  </tr>
                  <tr>
                    <td>Jam Kedatangan</td>
                    <td>:</td>
                    <td>{{ objectTriage.jam_kedatangan || "-" }}</td>
                  </tr>
                  <tr>
                    <td>Jam Mulai Pemeriksaan</td>
                    <td>:</td>
                    <td>{{ objectTriage.jam_mulai_pemeriksaan || "-" }}</td>
                  </tr>
                  <tr>
                    <td>Petugas</td>
                    <td>:</td>
                    <td>{{ objectTriage.username_petugas || "-" }}</td>
                  </tr>
                </table>
              </td>
            </tr>
              ...
              <td colspan="3">
                <table class="custom-table">
                  <tr>
                    ...
                    <td>:</td>
                    <td>
                      <p>{{ dataAssesmen.kategori_triage && dataAssesmen.kategori_triage.kategori_triage ? dataAssesmen.kategori_triage.kategori_triage : "-" }}</p>
                      <p>{{ dataAssesmen.kategori_triage && dataAssesmen.kategori_triage.kategori_triage_text ? dataAssesmen.kategori_triage.kategori_triage_text : "-" }}</p>
                    </td>
                  </tr>
                  <tr>
                    <td>Jalan Nafas</td>
                    <td>:</td>
                    <td>
                      <p>{{ dataAssesmen.kategori_triage && dataAssesmen.kategori_triage.jalan_nafas_kategori ? dataAssesmen.kategori_triage.jalan_nafas_kategori : "-" }}</p>
                      <p>{{ dataAssesmen.kategori_triage && dataAssesmen.kategori_triage.jalan_nafas_kategori_text ? dataAssesmen.kategori_triage.jalan_nafas_kategori_text : "-" }}</p>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>:</td>
                    <td>
                      <p>{{ dataAssesmen.kategori_triage && dataAssesmen.kategori_triage.ketidakmampuan_fisik_kategori ? dataAssesmen.kategori_triage.ketidakmampuan_fisik_kategori : "-" }}</p>
                      <p>{{ dataAssesmen.kategori_triage && dataAssesmen.kategori_triage.ketidakmampuan_fisik_kategori_text ? dataAssesmen.kategori_triage.ketidakmampuan_fisik_kategori_text : "-" }}</p>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>:</td>
                    <td>
                      <p>{{ dataAssesmen.kategori_triage && dataAssesmen.kategori_triage.nadi_carotis_kategori ? dataAssesmen.kategori_triage.nadi_carotis_kategori : "-" }}</p>
                      <p>{{ dataAssesmen.kategori_triage && dataAssesmen.kategori_triage.nadi_carotis_kategori_text ? dataAssesmen.kategori_triage.nadi_carotis_kategori_text : "-" }}</p>
                    </td>
                  </tr>
                  <tr>
                    <td>Pernafasan</td>
                    <td>:</td>
                    <td>
                      <p>{{ dataAssesmen.kategori_triage && dataAssesmen.kategori_triage.pernafasan_kategori ? dataAssesmen.kategori_triage.pernafasan_kategori : "-" }}</p>
                      <p>{{ dataAssesmen.kategori_triage && dataAssesmen.kategori_triage.pernafasan_kategori_text ? dataAssesmen.kategori_triage.pernafasan_kategori_text : "-" }}</p>
                    </td>
                  </tr>
                  <tr>
                    <td>Assesmen Triage</td>
                    <td>:</td>
                    <td>
                      <p>
                        {{ dataAssesmen.kategori_triage && dataAssesmen.kategori_triage.assesmen_triage_kategori ? dataAssesmen.kategori_triage.assesmen_triage_kategori : "-" }}
                      </p>
                      <p>
                        {{ dataAssesmen.kategori_triage && dataAssesmen.kategori_triage.assesmen_triage_kategori_text ? dataAssesmen.kategori_triage.assesmen_triage_kategori_text : "-" }}
                      </p>
                    </td>
                  </tr>
                </table>
...
export default {
  ...
  methods: {
    getTriageColor(kategori) {
      ...
      if (kategori.includes("Kategori 1")) return "#dc3545";
      if (kategori.includes("Kategori 2")) return "#ffc107";
      if (kategori.includes("Kategori 3")) return "#26cc01";
      if (kategori.includes("Kategori 4")) return "#b6b6b6";
      return "#6c757d";
    },
