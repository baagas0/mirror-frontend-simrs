              ...
              <form ref="assesmenForm" @submit.prevent="handleSubmit(createAssesmen)" autocomplete="off">
                <div class="card-body">
                  <div class="form-group mb-8">
                    <div class="alert alert-custom alert-default" role="alert">
                      ...
                      <div class="alert-text">
                        Isi diagnosa form dibawah ini untuk membuat assesmen keperawatan layanan IGD.
                      </div>
                    </div>
                  </div>
                  
                  <div class="col-6">
                    <s-input v-model="param_create_assesmen.tipe_diagnosa" :key="'tipe_diagnosa'" :id="'tipe_diagnosa'" :item="{
                      label: 'Tipe Diagnosa',
                      id: 'tipe_diagnosa',
                      data: 'tipe_diagnosa',
                      type: 'lookup-button',
                  ...
                  <div class="col-12" v-if="param_create_assesmen.tipe_diagnosa === 'ICD'">
                    <s-input v-model="param_create_assesmen.diagnosa" :key="'diagnosa'" :id="'diagnosa'" :item="{
                      label: 'Diagnosa',
                      id: 'diagnosa',
                      data: 'diagnosa',
                      type: 'lookup-radio',
                  ...
                  <div class="col-12" v-else>
                    <s-input v-model="param_create_assesmen.judul_diagnosa" :key="'judul_diagnosa'" :id="'judul_diagnosa'" :item="{
                      label: 'Diagnosa',
                      id: 'judul_diagnosa',
                      data: 'judul_diagnosa',
                      type: 'text',
...
<script>
  ...
  export default {
    ...
    methods: {
      selectRegistrasi (e, open_tab = 'anamnesa') {
