  ...
  <div class="d-flex flex-column">
    <div class="container-fluid">
                    ...
                    <b-col>
                      <h3 class="mb-0">
                        <strong><span @click="customAlert('error')">Registrasi</span> <span
                            @click="customAlert('success')">Rawat</span> Inap</strong>
                      </h3>
                    </b-col>
                  </b-row>
                </template>
                    ...
                    <b-row style="row-gap: 15px;">
                      ...
                      <b-col cols="3" v-if="conditionalFields.no_kontrol.value">
                        ...
                        <div>
                          ...
                          <b-input-group>
                            <b-form-input v-model='optionalFields.no_kontrol.text' :value="optionalFields.no_kontrol.text"
                              type='text' :placeholder="'Isikan No Kontrol'"></b-form-input>
                            <b-input-group-append>
                      ...
                      <b-col cols="3" v-if="modeSubmit !== modes.edit">
                        <s-input groupClass="mb-0" v-model="fields.tipe_kelas_kamar" :item="{
                          id: 'tipe_kelas_kamar',
                      ...
                      <b-col cols="3" v-if="modeSubmit !== modes.edit">
                        <s-input groupClass="mb-0" v-model="fields.ms_kelas_kamar_id" :item="{
                          label: 'Kelas Kamar',
                          id: 'bed_id',
                          data: 'bed_id',
                          type: 'lookup-radio',
                      ...
                      <b-col cols="3" v-if="modeSubmit !== modes.edit">
                        <s-input groupClass="mb-0" v-model="fields.ms_bed_id" :item="{
                          label: 'Bed',
                          id: 'bed_id',
                          data: 'bed_id',
                          type: 'lookup-radio',
                      ...
                      <div class="col-12" v-if="history_bed.length <= 0">
                        <div class="alert alert-custom alert-light-danger fade show mb-5" role="alert" style="border: 2px dashed #f64e60;">
                          ...
                          <div class="alert-text">
                            ...
                            <div class="row">
                              <b-col cols="3">
                                <s-input groupClass="mb-0" v-model="create_history_bed.tipe_kelas_kamar" :item="{
                                  id: 'tipe_kelas_kamar',
                                  // label: 'Tipe Kelas Kamar',
                              ...
                              <div class="col-3">
                                <s-input groupClass="mb-0" v-model="create_history_bed.ms_kelas_kamar_id" :item="{
                              ...
                              <div class="col-3">
                                <s-input groupClass="mb-0" v-model="create_history_bed.ms_bed_id" :item="{
                            ...
                            <div class="mt-4">
                              <button type="button" 
                                ...
                                v-if="
                                  history_bed.length
                                "
                                :disabled="history_bed[history_bed.length - 1].status_checkout === 1"
                                v-b-modal.modal-pindah 
                                @click="data_bed = history_bed[history_bed.length - 1]"
                              ...
                              <button 
                                ...
                                :disabled="
                                  history_bed.length <= 0 ||
                                  history_bed[history_bed.length - 1].status_checkout === 1
                                "
                                @click="checkoutBed(history_bed[history_bed.length - 1])"
                              >
      ...
      <b-modal id="modal-tutup-kunjungan" title="Tutup Kunjungan" hide-footer>
        ...
        <b-col cols="12">
          <div class="d-flex align-items-center mt-6">
            <b-button block sizes="lg" variant="primary" @click.prevent="submitForm" class="mt-0 text-nowrap">
      ...
      <ModalSEP :no_asuransi_registrasi="fields.no_asuransi_registrasi" :modalSEP1="modalSEP1" :modalSEP2="modalSEP2"
        :pesertaProps="fields" :jenisKunjungan="'Ranap'" @createdSEP="handleCreatedSEP" :noSEP="fields.no_sep"
        ...
        <b-col cols="12">
          <b-card class="" hide-header>
            <div>
              <b-row style="row-gap: 15px; margin-bottom: 2rem;">
                <b-col cols="12">
                  <DaftarKunjunganRegistrasi ref="table-daftar-kunjungan" :jenisKunjungan="'Ranap'"
...
export default {
  ...
  methods: {
    ...
    onSelectedMsBed(data) {
      this.$_api.post('msbed/detailsById', {
        id: data
      }).then((res) => {
        if (res.status === 200 && res.data.length > 0) {
    ...
    async cetakSurat(el) {
      ...
      const options = {
        ...
        styles: [
          '/static/assets/cetak/cetak-label-pasien.css',
        ],
    ...
    createHistoryBed() {
      ...
      this.$_alert.confirm('Yakin ingin menggunakan bed?').then((result) => {
        if (result.isConfirmed) {
          ...
          this.$_api.post('historyBed/register', payload).then((res) => {
            this.getHistoryBed()
