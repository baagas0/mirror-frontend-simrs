      ...
      if (this.$route.query.replace) {
        ...
        if (this.$store.state.globalFilter) {
          ...
          replaceFilter = Object.assign({}, {
            territory_id: this.dataset.territorys.data.length ? this.dataset.territorys.data[0] : { label: 'All Divisions', code: null },
            project_id: this.allProject ? { label: 'All Projects', code: null } : this.dataset.projects.data.length ? this.dataset.projects.data[0] : { label: 'All Projects', code: null }
          })
        }
      }
