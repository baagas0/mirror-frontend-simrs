<template>
    <div class="w-100">
      ...
      <modal-input
        :ep_be="ep_be"
        :list_penyusutan="list_penyusutan"
    ...
    methods: {
      ...
      async getDatas() {
        try {
          ...
          // let { resPenyusutan, errPenyusutan } = await useGetAxios("msDepreciationMethod/list");
          // console.log(resPenyusutan, 'penyusutan');
          // if (!resPenyusutan) {
          //   throw errPenyusutan;
          // } else {
          //   this.list_penyusutan = resPenyusutan;
          //   console.log(resPenyusutan, 'penyusutan');
          // }
        } catch (err) {
          if (err.message) {
        ...
        let penyusutan = await this.$_api.post("msDepreciationMethod/list");
        // console.log(penyusutan);
        this.list_penyusutan = penyusutan.data;
        console.log(this.list_penyusutan, 'penyusutan');
      },
      triggerAlert(event) {
        let vm = this;
