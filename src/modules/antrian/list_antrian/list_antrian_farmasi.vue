  ...
  <b-container fluid>
    <b-row>
      <b-col cols="12" md="12" lg="12">
        <h3 class="mb-5">
          <strong>List Antrian Farmasi</strong>
        </h3>
              ...
              <b-row>
                ...
                <b-col cols="9" md="9" lg="9">
                  <b-card class="bg-secondary text-light">
                    <b-row>
                      ...
                      <b-col cols="6" md="6" lg="6">
                        <h5 class="text-dark"><strong>Sedang Proses</strong></h5>
                        <hr />
                    ...
                    <b-row>
                      <b-col cols="12" md="12" lg="12">
                        <h5 class="text-dark"><strong>Selesai</strong></h5>
                        <hr />
                ...
                <b-col cols="3" md="3" lg="3">
                  <b-card style="
                    ...
                    <b-row>
                      <b-col cols="12" md="12" lg="12">
                        <h5 class="text-dark"><strong>Proses</strong></h5>
                        <hr />
                      </b-col>
                      <b-col cols="12" md="12" lg="12">
                        <b-row>
                          ...
                          <b-col cols="2" md="2" lg="2" offset-lg="2" offset-md="2" offset-sm="2">
                            <b-button :disabled="sedang_manggil" style="justify-content: flex-end" variant="success"
                              class="mr-1" @click="panggil()" v-b-tooltip.hover title="'Panggil'">
                              <i class="ri-notification-line"></i>
                            </b-button>
                          </b-col>
                        </b-row>
                      ...
                      <b-col cols="12" md="12" lg="12">
                        <b-row>
                          <b-col style="
                                ...
                                height: 250px;
                              ">
                            <p class="text-dark" style="font-size: 90px">
    ...
    <b-modal id="modal-pilihpoli" ref="modal" title="Selesai Antrian" size="lg" centered hide-footer hide-header>
      <b-form>
        <b-form-group label-cols-md="3">
          ...
          <multiselect :options="listPoli2" v-model="data2.idPoli" :multiple="false" :searchable="true"
            :close-on-select="true" :show-labels="false" label="nama" track-by="id" @input="getDokter2(data2.idPoli)"
            placeholder="-- Pilih Poli --"></multiselect>
        </b-form-group>
        ...
        <b-form-group label-cols-md="3">
          ...
          <multiselect :options="listDokter2" v-model="data2.idDokter" :multiple="false" :searchable="true"
            :close-on-select="true" :show-labels="false" label="nama" track-by="id" placeholder="-- Pilih Dokter --"
            :disabled="disabledDokter" @input="getJadwal2(data2.idDokter)"></multiselect>
        </b-form-group>
        ...
        <b-form-group label-cols-md="3">
          ...
          <multiselect :options="listJadwal2" v-model="data2.jadwal_dokter_id" :multiple="false" :searchable="true"
            :close-on-select="true" :show-labels="false" label="waktunya" track-by="id" placeholder="-- Pilih Jadwal --"
            :disabled="disabledJadwal"></multiselect>
        </b-form-group>
        <b-form-group>
    ...
    <b-modal id="modal-pilihlayanan" ref="modal" title="Selesai Antrian" size="lg" centered hide-footer hide-header>
      <b-form>
        <b-form-group label-cols-md="3">
          ...
          <multiselect :options="listLayanan" v-model="data3.poli_layanan" :multiple="false" :searchable="true"
            :close-on-select="true" :show-labels="false" label="nama" track-by="id" placeholder="-- Pilih Layanan --"
            @input="cekPoliLayanan(data3.poli_layanan)"></multiselect>
        </b-form-group>
...
export default {
  ...
  created () {
    this.$socket.off('refresh_admin_farmasi')
    this.$socket.on('refresh_admin_farmasi', (data) => {
      this.simpanData()
    })
  ...
  methods: {
    ...
    lokete () {
      let loket = new Audio(require(`../../../assets/sound/sound/farmasi1.wav`))
      setTimeout(() => {
        loket.play()
    ...
    nama_loket () {
      ...
      let farm = new Audio(
        require(`../../../assets/sound/sound/farmasi.wav`)
      )
      setTimeout(() => {
        nama_loket.play()
        setTimeout(() => {
