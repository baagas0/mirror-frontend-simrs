<template>
  <b-modal
    id="modal-pasien-external"
    size="xl"
    title="Pasien External"
      ...
      <b-card class="" header-tag="header" header-bg-variant="dark">
        ...
        <b-form>
          <b-form-group label-cols-md="3">
            ...
            <b-form-input
              :state="checkIfValid('pasien_id')"
              type="text"
              v-model="is_data.no_rm"
              disabled
            ></b-form-input>
          </b-form-group>
          <b-form-group label-cols-md="3">
          ...
          <b-form-group label-cols-md="3">
            ...
            <b-form-input
              :state="checkIfValid('nama_penjualan_external')"
              type="text"
              v-model="$v.is_data.nama_penjualan_external.$model"
            ></b-form-input>
          </b-form-group>
          <b-form-group label-cols-md="3">
            <template v-slot:label>
            ...
            <b-form-input
              :state="checkIfValid('alamat_penjualan_external')"
              type="text"
              v-model="$v.is_data.alamat_penjualan_external.$model"
            ></b-form-input>
          </b-form-group>
          <b-form-group label-cols-md="3">
            <template v-slot:label>
            ...
            <b-form-input
              :state="checkIfValid('keterangan_penjualan_external')"
              type="text"
              v-model="$v.is_data.keterangan_penjualan_external.$model"
            ></b-form-input>
          </b-form-group>
        </b-form>
        <div class="d-flex justify-content-end">
          <b-button class="mr-2" variant="warning" @click="$bvModal.hide('modal-pasien-external')">
            Batal
          </b-button>
          <b-button class="" variant="primary" :disabled="tableBusy || !isValid" @click="$emit('pilihPasienExternal', is_data), $bvModal.hide('modal-pasien-external')">
            Simpan
          </b-button>
        </div>
      </b-card>
              ...
              <b-col cols="12" md="12" lg="12">
                ...
                >
                  <template #cell(actions)="item">
                    <b-button
                      variant="success"
                      v-b-tooltip.hover="'Pilih Pasien'"
                      @click="pilihPasien(item.item)"
                    >
...
export default {
  ...
  methods: {
    ...
    async getDataSearch(){
      ...
      vm.items = pasien.status == 200 ? pasien.data.map((item, idx) => {return {
