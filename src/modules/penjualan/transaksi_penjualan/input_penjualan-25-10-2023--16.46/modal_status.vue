<template>
  <div>
    ...
    >
      ...
      <div class="">
        <b-button class="my-2 mx-1 px-3 w-100" variant="success" @click="updateStatus(1)" :disabled="busy || isDraft == 1">
          Open
        </b-button>
        <b-button class="my-2 mx-1 px-3 w-100" variant="warning" @click="updateStatus(2)" :disabled="busy || isDraft == 2">
          Lock
        </b-button>
      </div>
