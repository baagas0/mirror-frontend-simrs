            ...
            >
              ...
              <template #cell(actions)="item">
                <div v-if="listJual.length">
                  ...
                  >
                  <b-button
                    @click="$bvModal.show('modal-open-delete-barang'), data = item"
                    variant="danger"
                    size="sm"
                    :disabled="isDraft > 1"
  ...
  export default {
    ...
    methods: {
      ...
      async refreshListJual(){
        ...
        //list jual barang
        const listJual = listJualBarang.status == 200 ? await listJualBarang.data.map(x => {return {
          ...x, 
