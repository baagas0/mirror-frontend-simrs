<template>
  <b-modal id="modal-pasien" size="xl" title="List Kunjungan (Pasien Internal)" header-bg-variant="success" header-text-variant="light" @show="openModal()">
    <b-container fluid>
      <b-row>
        <b-col cols="12" md="12" lg="12">
          <b-row>
            ...
            <b-col cols="4" sm="4" md="4" lg="4">
              ...
              <multiselect id="jenis_layanan" v-model="filter.jenis_layanan" :options="list_jenis_layanan" :multiple="false" :searchable="true" :close-on-select="true" :show-labels="false" label="nama_jenis_layanan" track-by="id" placeholder="Jenis Layanan"></multiselect>
            </b-col>
            <b-col cols="4" sm="4" md="4" lg="4">
              <label for="tanggal_awal">Awal</label>
              <date-picker id="tanggal_awal" style="width: 100%" format="DD-MM-YYYY" placeholder="akhir" v-model="filter.tanggal_awal"></date-picker>
            </b-col>
            <b-col cols="4" sm="4" md="4" lg="4">
              <label for="tanggal_akhir">Akhir</label>
              <date-picker id="tanggal_akhir" style="width: 100%" format="DD-MM-YYYY" placeholder="akhir" v-model="filter.tanggal_akhir"></date-picker>
            </b-col>
          </b-row>
            ...
            <b-col cols="12" md="12" lg="12">
              <b-table :items="items" :fields="fields" responsive show-empty small bordered striped hover :busy="tableBusy">
                <template #cell(actions)="item">
                  <b-button variant="success" @click="$emit('pilihPasien', item.item), $bvModal.hide('modal-pasien')"> <i class="ri-check-line"></i> {{ item.actions }} </b-button>
                </template>
              </b-table>
            </b-col>
