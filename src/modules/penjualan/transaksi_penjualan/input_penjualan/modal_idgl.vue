<template>
  <b-modal id="modal-idgl" size="xl" title="IDGL" header-bg-variant="success" header-text-variant="light" @show="openModal()">
    <b-container fluid>
      <b-row>
        <b-col cols="12" md="12" lg="12">
          <b-row>
            <b-col cols="3" sm="3" md="3" lg="3">
              ...
              <b-form-input id="idgl_id" v-model="filter.idgl_id" debounce="300"></b-form-input>
            </b-col>
            <b-col cols="3" sm="3" md="3" lg="3">
              <label for="idgl">IDGL</label>
              <b-form-input id="idgl" v-model="filter.idgl" debounce="300"></b-form-input>
            </b-col>
            <b-col cols="3" sm="3" md="3" lg="3">
              <label for="tanggal_idgl">Tanggal</label>
              <date-picker id="tanggal_idgl" style="width: 100%" format="DD-MM-YYYY" placeholder="tanggal" v-model="filter.tanggal_idgl"></date-picker>
            </b-col>
            <b-col cols="3" sm="3" md="3" lg="3">
              <label for="no_invoice">NO. Invoice</label>
              <b-form-input id="no_invoice" v-model="filter.no_invoice" debounce="300"></b-form-input>
            </b-col>
            <b-col cols="3" sm="3" md="3" lg="3">
              <label for="judul">Judul</label>
              <b-form-input id="judul" v-model="filter.judul" debounce="300"></b-form-input>
            </b-col>
            <b-col cols="3" sm="3" md="3" lg="3">
              <label for="keterangan">Keterangan</label>
              <b-form-input id="keterangan" v-model="filter.keterangan" debounce="300"></b-form-input>
            </b-col>
            <b-col cols="3" sm="3" md="3" lg="3">
              <label for="type">Type</label>
              <b-form-input id="type" v-model="filter.type" debounce="300"></b-form-input>
            </b-col>
            <b-col cols="3" sm="3" md="3" lg="3">
              <label for="interesting_by">Inserting By</label>
              <b-form-input id="interesting_by" v-model="filter.interesting_by" debounce="300"></b-form-input>
            </b-col>
          </b-row>
            ...
            <b-col cols="auto">
              <b-row>
                <b-col cols="auto" class="m-0 p-0 mr-2">
                  <b-button @click="refresh()" :disabled="tableBusy" variant="danger"> Reset </b-button>
                </b-col>
                <b-col cols="auto" class="m-0 p-0">
                  <b-button @click="getDataSearch()" :disabled="tableBusy" variant="success"> Cari </b-button>
                </b-col>
              </b-row>
            </b-col>
          </b-row>
            ...
            <b-col cols="12" md="12" lg="12">
              <b-table :items="items" :fields="fields" responsive show-empty small bordered striped hover :busy="tableBusy">
                <template #cell(actions)="item">
                  <b-button variant="success" v-b-tooltip.hover="'Pilih Data'" @click="$emit('pilihPasien', item.item), $bvModal.hide('modal-idgl')"> <i class="ri-check-line"></i> {{ item.actions }} </b-button>
                </template>
              </b-table>
            </b-col>
