<template>
  <b-modal id="modal-form-barang-jual" size="md" centered title="Jual Barang" :header-bg-variant="dataForm.status_edit ? 'warning' : 'success'" header-text-variant="light">
    <b-form>
      ...
      <b-form-group label-cols-md="3">
        ...
        <b-form-input type="text" v-model="dataForm.keterangan_penjualan_barang"></b-form-input>
      </b-form-group>
    </b-form>
    <template #modal-footer>
      <b-button variant="secondary" @click="$bvModal.hide('modal-form-barang-jual')"> Tidak </b-button>
      <div v-if="isDraft == 1">
