                    ...
                    <b-col cols="9">
                      <b-row style="row-gap: 15px;" class="mx-1">
                        ...
                        <b-col cols="6">
                          ...
                          <s-input v-model="dataHeader.tgl_penjualan" :valuee="dataHeader.tgl_penjualan" :item="{
                            label: 'tanggal',
                            type: 'datetime',
                            validation: ['required'],
                        ...
                        <b-col cols="4">
                          <s-input v-model="dataHeader.jenis_layanan" :valuee="dataHeader.jenis_layanan" :item="{
                            label: 'Jenis Layanan',
                            type: 'lookup-radio',
                            validation: ['required'],
                            api: 'msJenisLayanan',
                        ...
                        <b-col cols="4">
                          <s-input v-model="dataHeader.dokter" :valuee="dataHeader.dokter" :item="{
                            id: 'dokter',
                            label: 'DPJP',
                            type: 'lookup-radio',
                            validation: [],
                          ...
                          }" :disabled="headerBusy || isDraft > 0"></s-input>
                        </b-col>
                        <b-col cols="4">
                          <s-input v-model="dataHeader.gudang" :valuee="dataHeader.gudang" :item="{
                            id: 'gudang',
                            label: 'Gudang',
                            type: 'lookup-radio',
                            validation: [],
                        ...
                        <b-col cols="4">
                          <s-input v-model="dataHeader.kelas_kunjungan" :valuee="dataHeader.kelas_kunjungan" :item="{
                            id: 'kelas_kunjungan',
                          ...
                          }" :disabled="dataHeader.registrasi_id != null || headerBusy || isDraft > 0"></s-input>
                        </b-col>
                        <b-col cols="4">
                          <s-input v-model="dataHeader.asuransi" :valuee="dataHeader.asuransi" :item="{
                            id: 'asuransi',
                            label: 'Asuransi',
                            type: 'lookup-radio',
                            validation: [],
                        ...
                        <b-col cols="4">
                          <s-input v-model="dataHeader.no_asuransi" :valuee="dataHeader.no_asuransi" :item="{
                            label: 'No. Asuransi',
                            id: 'no_asuransi',
                            type: 'text',
                            validation: [],
    ...
    methods: {
      ...
      async auto(){
        ...
        if(local){
          ...
          if(penjualan.status == 200 && penjualan.length){
      ...
      async getDatas() {
        ...
        this.list_asuransi = list_asuransi.status == 200 ? list_asuransi.map(x => { return {...x, nama_asuransi_harga: `${x.nama_asuransi} - ${x.nama_harga}` } } ) : []
        //kelas kunjungan
