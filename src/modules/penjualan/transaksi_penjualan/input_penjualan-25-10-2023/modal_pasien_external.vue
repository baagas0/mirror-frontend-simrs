      ...
      <b-card class="" header-tag="header" header-bg-variant="dark">
        ...
        <b-form>
          ...
          <b-form-group label-cols-md="3">
            ...
            <b-form-input
              type="text"
              v-model="is_data.nama_penjualan_external"
            ></b-form-input>
          </b-form-group>
          <b-form-group label-cols-md="3">
            <template v-slot:label>
            ...
            <b-form-input
              type="text"
              v-model="is_data.alamat_penjualan_external"
            ></b-form-input>
          </b-form-group>
          <b-form-group label-cols-md="3">
            <template v-slot:label>
            ...
            <b-form-input
              type="text"
              v-model="is_data.keterangan_penjualan_external"
            ></b-form-input>
          </b-form-group>
        </b-form>
        <div class="d-flex justify-content-end">
          ...
          <b-button class="" variant="primary" :disabled="tableBusy" @click="$emit('pilihPasienExternal', is_data), $bvModal.hide('modal-pasien-external')">
            Simpan
          </b-button>
        </div>
      </b-card>
...
export default {
  ...
  methods: {
    ...
    async getDataSearch(){
      ...
      vm.items = pasien.status == 200 ? pasien.map((item, idx) => {return {
