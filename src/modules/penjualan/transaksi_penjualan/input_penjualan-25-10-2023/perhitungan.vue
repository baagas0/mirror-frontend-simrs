...
export default {
  ...
  methods: {
    async openRegister () {
      ...
      vm.$bvModal.show('modal-register')
    },
    triggerAlert (event) {
      let vm = this
