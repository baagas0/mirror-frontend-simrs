...
import display_apm from '@/modules/antrian/display_apm.vue'
import display_layar_poli from '@/modules/antrian/display_layar_poli.vue'
import display_layar_loket from '@/modules/antrian/display_layar_loket.vue'
...
var router = new Router({
  routes: [
    {
      path: '/antrian/display-layar-poli',
      name: 'display-layar-poli',
      component: display_layar_poli
    },
    {
      path: '/antrian/display-apm',
      name: 'display-apm',
      component: display_apm
    },
    {
      path: '/antrian/display-layar-loket',
      name: 'display-layar-loekt',
      component: display_layar_loket
    },
    {
      path: '/term-condition',
      name: 'term-condition',
...
router.beforeEach((to, from, next) => {
  if (localStorage.getItem('modules') !== undefined || localStorage.getItem('modules') !== null) {
    let noAuth = ['display-apm', 'sso-login-apps', 'login-apps', 'privacy-policy', 'term-condition', 'register-apps', 'verify-apps', 'waiting-apps', 'reset-apps', 'soc-page']
