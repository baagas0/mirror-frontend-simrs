...
import "@/components/_global-component.js";
...
import socketss from "@/utils/socketio.service";
...
Vue.use(Geocoder, {
  ...
  googleMapsApiKey: "AIzaSyArJkzKNSGOGAwtMcsCl6cRlFfAG_dIqmE",
});
...
// let token = savedToken ? JSON.parse(savedToken) : null
let token = "";
try {
  ...
  console.error("Token Error (main.js)");
